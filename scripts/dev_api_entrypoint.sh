...
gcc -I../api_server -I/usr/include/postgresql -DUSE_OPENSSL -DNO_SSL_DL -DOPENSSL_API_1_1 -O0 -g -c \
    ast.c mysql_bridge.c postgres_bridge.c sqlserver_bridge.c db_params.c orm_bridge.c typeeasy_api.c debugger.c te_builtins.c te_http.c te_json.c te_bytecode.c te_csv.c te_xlsx.c te_colcache.c te_stdlib.c te_bridge.c te_async.c te_evloop.c te_linq.c te_linq_ops.c te_math.c te_string.c te_list.c te_map.c te_print.c te_interp_flow.c te_value.c te_vm.c te_decimal.c te_interp_decl.c te_fmt.c \
...
gcc -I/app/api_server -I/app/src -DUSE_OPENSSL -DNO_SSL_DL -DOPENSSL_API_1_1 -O0 -g \
    ...
    /app/src/ast.o /app/src/mysql_bridge.o /app/src/postgres_bridge.o /app/src/sqlserver_bridge.o /app/src/db_params.o /app/src/orm_bridge.o \
    /app/src/typeeasy_api.o /app/src/debugger.o /app/src/te_builtins.o /app/src/te_http.o /app/src/te_json.o /app/src/te_bytecode.o /app/src/te_csv.o /app/src/te_xlsx.o /app/src/te_colcache.o /app/src/te_stdlib.o /app/src/te_bridge.o /app/src/te_async.o /app/src/te_evloop.o /app/src/te_linq.o /app/src/te_linq_ops.o /app/src/te_math.o /app/src/te_string.o /app/src/te_list.o /app/src/te_map.o /app/src/te_print.o /app/src/te_interp_flow.o /app/src/te_value.o /app/src/te_vm.o /app/src/te_interp_decl.o /app/src/te_fmt.o te_print.o te_interp_flow.o te_value.o te_vm.o te_decimal.o te_interp_decl.o /app/src/te_fmt.o /app/src/parser.tab.o /app/src/lex.yy.o \
