...
gcc -I../api_server -I/usr/include/postgresql -DUSE_OPENSSL -DNO_SSL_DL -DOPENSSL_API_1_1 -O0 -g -c \
    ast.c bytecode.c mysql_bridge.c postgres_bridge.c sqlserver_bridge.c db_params.c orm_bridge.c typeeasy_api.c debugger.c te_builtins.c te_http.c te_json.c te_bytecode.c \
...
gcc -I/app/api_server -I/app/src -DUSE_OPENSSL -DNO_SSL_DL -DOPENSSL_API_1_1 -O0 -g \
    ...
    /app/src/typeeasy_api.o /app/src/debugger.o /app/src/te_builtins.o /app/src/te_http.o /app/src/te_json.o /app/src/te_bytecode.o /app/src/parser.tab.o /app/src/lex.yy.o /app/src/strvars.o \
