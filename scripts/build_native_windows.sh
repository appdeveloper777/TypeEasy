...
gcc $CFLAGS_NATIVE -fno-semantic-interposition -c \
    ...
    wasm_backend.c debugger.c db_params.c te_builtins.c te_http.c te_json.c te_bytecode.c te_csv.c te_xlsx.c te_colcache.c te_stdlib.c te_bridge.c te_async.c te_evloop.c te_linq.c te_linq_ops.c te_math.c te_string.c te_list.c te_map.c db_stubs_win.c ${SQLSERVER_SRC}
...
gcc -O3 -fopenmp -o typeeasy.exe \
    ...
    db_params.o te_builtins.o te_http.o te_json.o te_bytecode.o te_csv.o te_xlsx.o te_colcache.o te_stdlib.o te_bridge.o te_async.o te_evloop.o te_linq.o te_linq_ops.o te_math.o te_string.o te_list.o te_map.o db_stubs_win.o ${SQLSERVER_OBJ} \
