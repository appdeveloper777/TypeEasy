...
MOTOR_OBJS="ast.o mysql_bridge.o postgres_bridge.o sqlserver_bridge.o \
...
te_list.o te_map.o te_print.o te_interp_flow.o te_value.o te_vm.o te_decimal.o te_interp_decl.o te_fmt.o"
...
( cd "$SRC" && "$CC" -fsanitize=fuzzer,address -g -fno-omit-frame-pointer -fopenmp \
  ...
  -lm -lmysqlclient -lpq -lsybdb -lpthread -ldl -lssl -lcrypto -lcurl -lz )
